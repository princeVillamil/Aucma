    ...
    <section className="h-screen flex">
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
        <div className="text-center">
          <Typography variant="h2" className="font-bold mb-4 text-gray-900">Login</Typography>
          <Typography variant="paragraph" className="text-lg font-normal text-blue-gray-500">
            Enter your email and password to Login.
          </Typography>
        </div>
        <form onSubmit={onSubmit} className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          <div className="mb-1 flex flex-col gap-6">
            <Typography variant="small" className="-mb-3 font-medium text-blue-gray-900">
              Your email
            </Typography>
            <Input
          ...
          <Checkbox
            label={
              <Typography
                variant="small"
                className="flex items-center justify-start font-medium text-blue-gray-500"
              >
                I agree the&nbsp;
                <a
                  href="#"
          ...
          <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
            Not registered?
            <Link to="/register" className="text-gray-900 ml-1 hover:underline">Create account</Link>
          </Typography>
        </form>
      </div>
