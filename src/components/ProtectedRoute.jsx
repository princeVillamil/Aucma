...
import { getDocumentById, getAllTechnicians } from "../firebase/firestoreFunctions.js";
...
export default function ProtectedRoute({ role, children }) {
  ...
  useEffect(() => {
    const verifyUser = async () => {
      ...
      try {
        ...
        const technicianListData = await getAllTechnicians()
        setTechnicianList(technicianListData)
        setUserData(data);
  ...
  return cloneElement(children, { userData, technicianList });
}
